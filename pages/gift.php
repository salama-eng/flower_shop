...
<div id="id01" class="w3-modal">
  <div class="w3-modal-content">
    <div class="w3-container">
      ...
      >x</p>
      Are You sure you want to pay this flower ?  
...
<?php }}  ?>
    ...
    <section class="we-love">
      <img src="../assets/gift_1.png" alt="" width="500" height="" class="reveal fade-left"/>
  <div class="we-love-text reveal fade-right">
   <h1>Our Pricing</h1>
    <p>gift is ever the same, that’s why we are here to assist in creating a fully customised proposal to meet your specific requirements (no matter how specific) within all budgets.</p>
